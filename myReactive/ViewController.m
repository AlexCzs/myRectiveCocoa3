...
- (void)loginVC{
    UIButton *loginButn = [[UIButton alloc]initWithFrame:CGRectMake(0, 0, 200, 44)];
    [loginButn setTitle:@"login" forState:UIControlStateNormal];
    loginButn.backgroundColor = [UIColor redColor];
    loginButn.center = self.view.center;
    [self.view addSubview:loginButn];
    
    [[loginButn rac_signalForControlEvents:UIControlEventTouchUpInside] subscribeNext:^(id x) {
...
- (void)afnNetWork{
    ...
    RACSignal *request1 = [RACSignal createSignal:^RACDisposable *(id<RACSubscriber> subscriber) {
        [[AFHTTPSessionManager manager]GET:@"http://123.56.6.91:7390/earthshaker/user/v2/awardList.do?access_token=admin"
                                parameters:nil
                                  progress:nil
...
- (void)viewforRAC{
    RedView *redV = [[RedView alloc]initWithFrame:CGRectMake(0, 0, 50, 50)];
    ...
    btn.frame = CGRectMake(50, 50, 20, 20);
    // 3.监听事件
